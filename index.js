...
app.post('/word_type/all', db.getAllWordTypeContent)
app.post('/word_type/activate/:linkId', db.activateWordTypeLink)
app.post('/word_type/deactivate/:linkId', db.deactivateWordTypeLink)
